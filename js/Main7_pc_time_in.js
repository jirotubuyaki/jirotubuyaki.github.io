		...
		var angle_z=0;
		function init(){
			canvas = document.getElementById("mycanvas_in");
			stage = new createjs.Stage(document.getElementById("mycanvas_in"));
			...
			Clock(stage,stage.canvas.width/2-320,stage.canvas.height-300,1);
			Clock(stage,stage.canvas.width/2-200,stage.canvas.height-300,2);
			Clock(stage,stage.canvas.width/2-55,stage.canvas.height-300,3);
			Clock(stage,stage.canvas.width/2+55,stage.canvas.height-300,4);
			Clock(stage,stage.canvas.width/2+200,stage.canvas.height-300,5);
			Clock(stage,stage.canvas.width/2+320,stage.canvas.height-300,6);

			var graphics = new createjs.Graphics();
			graphics
			.setStrokeStyle(2.2)
     		.beginStroke("#eeeeee")
     		.arc(stage.canvas.width/2+128,stage.canvas.height-250,12,360,0,true);
			...
			.setStrokeStyle(2.2)
     		.beginStroke("#eeeeee")
     		.arc(stage.canvas.width/2+128,stage.canvas.height-160,12,360,0,true);
			shape = new createjs.Shape(graphics);
			stage.addChild(shape);
				...
				for(var i=0;i<point_x_1_arry_mem.length;i++){
		    		...
		    		shape_obj[i].graphics.lineTo(point_x_2_arry_2[i]+stage.canvas.width/2,point_y_2_arry_2[i]+stage.canvas.height/2-300);
		     		...
		     		if(particle_obj.length >i){
						...
						particle_obj[i].graphics.setStrokeStyle(0.55);
				...
				createjs.Ticker.addEventListener("tick", function() {
					...
					for(var k=0;k<7;k++){
			    		if(time_flag == true){
			    			...
			    			segment[k].graphics.setStrokeStyle(0.3);
					...
					if(time_flag == true){
						...
						for(var k=0;k<time_obj.length;k++){
							...
							time_obj[k].graphics.clear();
					   		time_obj[k].graphics.setStrokeStyle(0.3);
