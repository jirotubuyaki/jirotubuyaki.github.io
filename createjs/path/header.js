		...
		function init(){
			...
			Clock(stage,stage.canvas.width/2-240,stage.canvas.height/2,1);
			Clock(stage,stage.canvas.width/2-160,stage.canvas.height/2,2);
			Clock(stage,stage.canvas.width/2-35,stage.canvas.height/2,3);
			Clock(stage,stage.canvas.width/2+35,stage.canvas.height/2,4);
			Clock(stage,stage.canvas.width/2+160,stage.canvas.height/2,5);
			Clock(stage,stage.canvas.width/2+240,stage.canvas.height/2,6);

			var graphics = new createjs.Graphics();
			graphics
			.setStrokeStyle(2.0)
     		.beginStroke("#eeeeee")
     		.arc(stage.canvas.width/2+100,stage.canvas.height/2+90,10,360,0,true);
			...
			.setStrokeStyle(2.0)
     		.beginStroke("#eeeeee")
     		.arc(stage.canvas.width/2+100,stage.canvas.height/2+30,10,360,0,true);
			shape = new createjs.Shape(graphics);
			stage.addChild(shape);
		...
		var Clock = function(parent_in,x_in,y_in,clock_in){
			...
			for(var j=0;j<7;j++){
    			...
    			shape.graphics.beginStroke("#bbbbbb");
				...
				function act(){
					...
					for(var k=0;k<7;k++){
			    		...
			    		if(time_flag == true){
			    			...
			    			segment[k].graphics.beginStroke("#bbbbbb");
