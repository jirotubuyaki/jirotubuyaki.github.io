var start = function() {
    ...
    flower_obj_1.init().setSize(70).setPetalSize(80).setColor("#ff1493").setPetal(8).setPile(2,1.2).setAlpha(0.5).create(200,200);
    flower_obj_2.init().setSize(20).setPetalSize(80).setColor("#ff1493").setPetal(8).setPile(3,1.2).setAlpha(0.5).create(200,200);
    ...
    flowerrnd_obj_1.init().setSize(70).setPetalSize(80).setColor("#ff1493").setPetal(8).setPile(2,1.2).setNoise(1.0).setAlpha(0.5).create(500,200);
    flowerrnd_obj_2.init().setSize(20).setPetalSize(80).setColor("#ff1493").setPetal(8).setPile(3,1.2).setNoise(1.0).setAlpha(0.5).create(500,200);
    ...
    .to({rotation:360,x:500,y:300},1000)
    .to({x:500,y:200,petal_index:0,petal_scale_0:1.3},300,createjs.Ease.cubicOut)
    .to({petal_scale_1:1.3},300,createjs.Ease.cubicOut)
    .to({petal_scale_2:1.3},300,createjs.Ease.cubicOut)
    .to({petal_scale_3:1.3},300,createjs.Ease.cubicOut)
    .to({petal_scale_4:1.3},300,createjs.Ease.cubicOut)
